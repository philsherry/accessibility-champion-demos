 ...
 * announcement.
 *
 * Called from assets/js/orders.js's and assets/js/index.js's own
 * button listeners — both separate files, invisible to ESLint's static
 * analysis, hence the `exported` pragma below telling no-unused-vars
 * this global is consumed elsewhere.
 *
